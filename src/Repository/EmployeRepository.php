...
class EmployeRepository extends ServiceEntityRepository
{
    ...
    //  * @return Query
    //  */
    // public function findAllVisibleQuery(Employe $employe): ORMQuery
    // {
    //     $query = $this->createQueryBuilder('employe')
    //         ->andWhere('employe.visible = :visible OR employe.visible = 0')
